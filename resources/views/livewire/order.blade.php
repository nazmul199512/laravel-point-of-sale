...
{{--                          {{ $productInCart }}--}}
                        ...
                        <table class="table table-bordered table-left cart-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" name="quantity[]" value="{{$cart->product_qty}}" id="quantity" class="form-control quantity">
                                </td>
                                <td>
                                    <input type="number" name="price[]" value="{{$cart->product->price}}" id="price" class="form-control price">
                                </td>
                                ...
                                <td>
                                    <input type="number" name="total_amount[]" value="{{ $cart->product_qty * $cart->product->price  }}" id="total_amount" class="form-control total_amount">
                                </td>

                                <td>
                                    <a href="#" class="btn btn-sm btn-danger delete rounded-circle"><i class="fa fa-times" wire:click="removeProduct({{ $cart->id  }})"></i> </a>
                                </td>
